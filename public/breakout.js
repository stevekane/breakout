...
},{"./audio":4,"./gl-utils":6,"./loaders":7,"dat-gui":1}],6:[function(require,module,exports){
"use strict";

var utils = {};

var clearContext = function (gl, color) {
  if (color) gl.clearColor(color.r, color.g, color.b, color.a);else gl.clearColor(0, 0, 0, 0);
